...
! function(a, b, c) {
    a.fn.scrollUp = function(b) { a.data(c.body, "scrollUp") || (a.data(c.body, "scrollUp", !0), a.fn.scrollUp.init(b)) }, a.fn.scrollUp.init = function(d) {
        var e = a.fn.scrollUp.settings = a.extend({}, a.fn.scrollUp.defaults, d),
            f = a("<a/>", { id: e.scrollName, href: "#top", title: e.scrollText }).appendTo("body");
        e.scrollImg || f.html(e.scrollText), f.css({ display: "none", position: "fixed", zIndex: e.zIndex }), e.activeOverlay && a("<div/>", { id: e.scrollName + "-active" }).css({ position: "absolute", top: e.scrollDistance + "px", width: "100%", borderTop: "1px dotted" + e.activeOverlay, zIndex: e.zIndex }).appendTo("body"), scrollEvent = a(b).scroll(function() {
        ...
        }), f.click(function(b) { b.preventDefault(), a("html, body").animate({ scrollTop: 0 }, e.topSpeed, e.easingType) })
    }, a.fn.scrollUp.defaults = { scrollName: "scrollUp", scrollDistance: 300, scrollFrom: "top", scrollSpeed: 300, easingType: "linear", animation: "fade", animationInSpeed: 200, animationOutSpeed: 200, scrollText: "Scroll to top", scrollImg: !1, activeOverlay: !1, zIndex: 2147483647 }, a.fn.scrollUp.destroy = function(d) { a.removeData(c.body, "scrollUp"), a("#" + a.fn.scrollUp.settings.scrollName).remove(), a("#" + a.fn.scrollUp.settings.scrollName + "-active").remove(), a.fn.jquery.split(".")[1] >= 7 ? a(b).off("scroll", d) : a(b).unbind("scroll", d) }, a.scrollUp = a.fn.scrollUp
}(jQuery, window, document);
! function(t) {
    "use strict";
    t.fn.counterUp = function(e) {
        var a, n = t.extend({ time: 400, delay: 10, formatter: !1, callback: function() {} }, e);
        return this.each(function() {
            var e = t(this),
                r = { time: t(this).data("counterup-time") || n.time, delay: t(this).data("counterup-delay") || n.delay },
                u = function() {
                    var t = [],
                        u = r.time / r.delay,
                        o = e.text(),
                    ...
                    var v = function() { e.html(e.data("counterup-nums").shift()), e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), r.delay) : (e.data("counterup-nums", null), e.data("counterup-func", null), n.callback.call(this)) };
                    e.data("counterup-func", v), setTimeout(e.data("counterup-func"), r.delay)
                };
            e.waypoint(function() { u(), this.destroy() }, { offset: "100%" })
        })
    }
}(jQuery);
...
! function(e, t) {
    ...
    var ae = ne.document,
        ...
        i = function(e, t) {
            ...
            Z.ariaLabels = Object.assign({}, { open: "Open Menu", close: "Close Menu", submenu: "Submenu" }, t.ariaLabels);
            var ee = [],
                te = function(e) { if (!ee.length) return !1; var t = !1; "string" == typeof e && (e = [e]); for (var n = e.length, a = 0; a < n; a++) - 1 !== ee.indexOf(e[a]) && (t = !0); return t },
                n = function(e) {
                    if (e.querySelector("ul") || "UL" === e.tagName) {
                        ...
                        var n, u, a, d = null,
                            ...
                            N = !1,
                            T = !1;
                        Z.customToggle ? (d = R.getElement(Z.customToggle)) && (d.classList.add("hc-nav-trigger", E), d.addEventListener("click", K)) : ((d = R.createElement("a", { href: "#", class: "hc-nav-trigger " + E, "aria-label": (Z.ariaLabels || {}).open }, R.createElement("span"))).addEventListener("click", K), e.insertAdjacentElement("afterend", d)), d.setAttribute("role", "button"), d.setAttribute("aria-controls", E), d.addEventListener("keydown", function(e) { "Enter" !== e.key && 13 !== e.keyCode || setTimeout(function() { w(0, 0) }, 0) });
                        var w = function(e, t, n) {
                                if ("number" == typeof t && ("number" == typeof e || k.length)) {
                                    var a = Array.prototype.filter.call(v.querySelectorAll(".nav-wrapper"), function(e) { return e.getAttribute("data-level") == t && ("number" != typeof n || "number" == typeof n && e.getAttribute("data-index") == n) })[0];
                                    if (a = R.children(a, ".nav-content")[0], a = R.children(a, "ul"), a = R.children(a, "li"), a = R.children(a, ":not(.nav-wrapper)"), a = Array.prototype.map.call(a, function(e) { return Array.prototype.slice.call(e.querySelectorAll('[tabindex="0"], a[href], button, textarea, input[type="text"], input[type="radio"], input[type="checkbox"], select')) }).flat(), a = Array.prototype.filter.call(a, function(e) { return "-1" !== e.getAttribute("tabindex") })) {
                                        var r = a[0],
                                            i = a[a.length - 1];
                                        "number" == typeof e ? a[e].focus() : (k[k.length - 1].focus(), k.pop()), ae.removeEventListener(s), ae.addEventListener(s, function(e) { "Tab" !== e.key && 9 !== e.keyCode || (e.shiftKey ? ae.activeElement === r && (e.preventDefault(), i.focus()) : ae.activeElement === i && (e.preventDefault(), r.focus())) })
                                    }
                                }
                            },
                            S = function() { ae.removeEventListener(s), setTimeout(function() { d.focus() }, u) },
                            M = function() {
                            ...
                            P = function() {
                                ...
                                r = function o(e, t) {
                                    ...
                                    Array.prototype.forEach.call(e, function(e) {
                                        var s = { id: t, classes: e.getAttribute("class") || null, items: [] };
                                        null !== e.getAttribute("data-nav-active") && (m = t, e.removeAttribute("data-nav-active")), Array.prototype.forEach.call(e.children, function(e) {
                                            var t = null !== e.getAttribute("data-nav-custom-content"),
                                                n = t ? e.children : Array.prototype.filter.call(e.children, function(e) { return "UL" !== e.tagName && !e.querySelector("ul") }).concat(e.children.length ? [] : [e.firstChild]),
                                                a = t ? [] : Array.prototype.slice.call(e.querySelectorAll("ul")),
                                                r = a.length ? [a[0]].concat(Array.prototype.filter.call(a[0].parentNode.children, function(e) { return "UL" === e.tagName && e !== a[0] })) : [],
                                                i = null;
                                            r.length && (R.data(e, "hc-uniqid") ? i = R.data(e, "hc-uniqid") : (i = Math.random().toString(36).substr(2), R.data(e, "hc-uniqid", i))), null !== e.getAttribute("data-nav-active") && (m = i, e.removeAttribute("data-nav-active")), s.items.push({ id: i, classes: e.getAttribute("class") || "", content: n, custom: t, subnav: r.length ? o(r, i) : [], highlight: null !== e.getAttribute("data-nav-highlight") })
                                        }), n.push(s)
                                    });
                                    return n
                                }((t = Array.prototype.slice.call(e.querySelectorAll("ul")), "UL" === e.tagName && t.unshift(e), [t[0]].concat(Array.prototype.filter.call(t[0].parentNode.children, function(e) { return e !== t[0] }))), null)
                            },
                            _ = function(e) {
                                if (e) {
                                    ...
                                    var g = R.createElement("div", { class: "nav-wrapper nav-wrapper-" + y, "data-level": y, "data-index": n || 0 });
                                    var r = R.createElement("div", { class: "nav-content" });
                                    g.addEventListener("click", R.stopPropagation);
                                    g.appendChild(r);
                                    t.appendChild(g);
                                    b && r.insertBefore(R.createElement("h2", { class: 0 === y ? "nav-title" : "level-title" }, b), r.firstChild);
                                    e.forEach(function(e, t) {
                                        var h = R.createElement("ul", { role: "menu", "aria-level": y + 1 });
                                        r.appendChild(h), Z.keepClasses && e.classes && h.classList.add.apply(h.classList, e.classes.split(" ")), 0 === t && b && h.setAttribute("aria-label", b), e.id && h.setAttribute("aria-labelledby", "menu-" + e.id), e.items.forEach(function(e, t) {
                                            var n = e.content;
                                            if (e.custom) { var a = R.createElement("li", { class: "custom-content" }, R.createElement("div", { class: "nav-item nav-item-custom" }, Array.prototype.map.call(n, function(e) { return R.clone(e, !0, !0) }))); return Z.keepClasses && e.classes && a.classList.add.apply(a.classList, e.classes.split(" ")), void h.appendChild(a) }
                                            var r, i = Array.prototype.filter.call(n, function(e) { return "A" === e.tagName || 3 !== e.nodeType && e.querySelector("a") })[0];
                                            i ? (r = R.clone(i, !1, !0)).classList.add("nav-item") : r = R.createElement(e.subnav.length ? "a" : "span", { class: "nav-item" }, Array.prototype.map.call(n, function(e) { return R.clone(e, !0, !0) })), "A" === r.tagName && (r.setAttribute("tabindex", "0"), r.setAttribute("role", "menuitem"), r.getAttribute("href") || r.setAttribute("href", "#")), i && r.addEventListener("click", function(e) { e.stopPropagation(), R.hasListener(i, "click") && i.click() }), "#" === r.getAttribute("href") && r.addEventListener("click", R.preventDefault), Z.closeOnClick && (W() ? "A" !== r.tagName || "false" === r.dataset.navClose || null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled") || e.subnav.length && (!r.getAttribute("href") || "#" === r.getAttribute("href").charAt(0)) || r.addEventListener("click", G) : "A" !== r.tagName || "false" === r.dataset.navClose || null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled") || r.addEventListener("click", G));
                                            var s = R.createElement("li");
                                            if (s.appendChild(r), h.appendChild(s), Z.keepClasses && e.classes && (s.className = e.classes), e.highlight && s.classList.add("nav-highlight"), R.wrap(r, R.createElement("div", { class: "nav-item-wrapper" })), Z.levelSpacing && ("expand" === Z.levelOpen || !1 === Z.levelOpen || "none" === Z.levelOpen)) {
                                            ...
                                            if (e.subnav.length) {
                                                ...
                                                if (A[l] || (A[l] = 0), s.classList.add("nav-parent"), W()) {
                                                    var u = A[l],
                                                        d = R.createElement("input", { type: "checkbox", id: E + "-" + l + "-" + u, class: "hc-chk", tabindex: -1, "data-level": l, "data-index": u, value: c });
                                                    ...
                                                    var p = function(e) {
                                                        ...
                                                        }), e.addEventListener("keydown", function(e) { "Enter" !== e.key && 13 !== e.keyCode || (C = !0, k.push(this)) }), e.setAttribute("aria-controls", "menu-" + c), e.setAttribute("aria-haspopup", "overlap" === Z.levelOpen), e.setAttribute("aria-expanded", !1)
                                                    };
                                                    if (-1 !== x.indexOf(c) && (g.classList.add("sub-level-open"), g.addEventListener("click", function() { return J(l, u) }), s.classList.add("level-open"), d.setAttribute("checked", !0)), v = !0 === Z.levelTitles ? n[0].textContent.trim() : "", r.getAttribute("href") && "#" !== r.getAttribute("href")) {
                                                        var f = R.createElement("a", { href: "#", class: "nav-next", "aria-label": (Z.ariaLabels || {}).submenu + ": " + v, role: "menuitem", tabindex: 0 }, R.createElement("span"));
                                                        f.addEventListener("click", R.preventClick()), r.parentNode.insertBefore(f, r.nextSibling), p(f)
                                                    } else r.appendChild(R.createElement("span", { class: "nav-next" }, R.createElement("span"))), p(r)
                                    ...
                                    if (y && void 0 !== n && !1 !== Z.insertBack && "overlap" === Z.levelOpen) {
                                        var i = R.children(r, "ul"),
                                            ...
                                            o = R.createElement("a", { href: "#", role: "menuitem", tabindex: 0 }, [s, R.createElement("span")]),
                                            l = R.createElement("li", { class: "nav-back" }, o),
                                            c = function() { return J(y, n) };
                                        R.wrap(o, R.createElement("div", { class: "nav-item-wrapper" })), o.addEventListener("click", R.preventClick(c)), o.addEventListener("keydown", function(e) { "Enter" !== e.key && 13 !== e.keyCode || (C = !0) }), !0 === Z.insertBack ? i[0].insertBefore(l, i[0].firstChild) : R.isNumeric(Z.insertBack) && R.insertAt(l, Z.insertBack, i)
                                    }
                                    if (0 === y && !1 !== Z.insertClose) {
                                        var v = R.children(r, "ul"),
                                            u = R.createElement("a", { href: "#", role: "menuitem", tabindex: 0 }, "object" == typeof Z.labelClose ? R.getElement(Z.labelClose) : [Z.labelClose || "", R.createElement("span")]),
                                            d = R.createElement("li", { class: "nav-close" }, u);
                                        Z.labelClose && "" !== Z.labelClose || u.setAttribute("aria-label", (Z.ariaLabels || {}).close), R.wrap(u, R.createElement("div", { class: "nav-item-wrapper" })), u.addEventListener("click", R.preventClick(G)), u.addEventListener("keydown", function(e) { "Enter" !== e.key && 13 !== e.keyCode || S() }), !0 === Z.insertClose ? v[0].insertBefore(d, v[0].firstChild) : R.isNumeric(Z.insertClose) && R.insertAt(d, Z.insertClose, v)
                                    }
                                }(r, v, 0, Z.navTitle)
                            },
                            t = function(t) { return function(e) { "left" !== Z.position && "right" !== Z.position || (o = e.touches[0].clientX, O = e.touches[0].clientY, "doc" === t ? T || (ae.addEventListener("touchmove", q, R.supportsPassive), ae.addEventListener("touchend", D, R.supportsPassive)) : (T = !0, v.addEventListener("touchmove", H, R.supportsPassive), v.addEventListener("touchend", I, R.supportsPassive))) } },
                            j = function(e, t) { ne.addEventListener("touchmove", R.preventDefault, R.supportsPassive), c.style.visibility = "visible", v.style[R.browserPrefix("transition")] = "none", R.setTransform(v, e, Z.position), p && (p.style[R.browserPrefix("transition")] = "none", R.setTransform(p, t, Z.position)) },
                            B = function(e, t, n, a) { void 0 === t && (t = !0), void 0 === n && (n = !1), void 0 === a && (a = !1), ne.removeEventListener("touchmove", R.preventDefault, R.supportsPassive), v.style[R.browserPrefix("transition")] = "", R.setTransform(v, n, Z.position), p && (p.style[R.browserPrefix("transition")] = "", R.setTransform(p, a, Z.position)), "open" === e ? Y() : (G(), t ? setTimeout(function() { c.style.visibility = "" }, u) : c.style.visibility = "") },
                            q = function(e) {
                        ...
                        return c.on = function(e, t) { c.addEventListener(e, t) }, c.off = function(e, t) { c.removeEventListener(e, t) }, c.getSettings = function() { return Object.assign({}, Z) }, c.isOpen = X, c.open = Y, c.close = G, c.update = function(e, t) {
                    ...
                    function W() { return !1 !== Z.levelOpen && "none" !== Z.levelOpen }

                    function X() { return f }

                    function F() { return x.length ? Number(Array.prototype.filter.call(v.querySelectorAll(".hc-chk"), function(e) { return e.value == x[x.length - 1] })[0].dataset.level) : 0 }

                    function Q() { return x.length ? Number(Array.prototype.filter.call(v.querySelectorAll(".hc-chk"), function(e) { return e.value == x[x.length - 1] })[0].dataset.index) : 0 }
                    ...
                    function Y(e, t) {
                        if ((!X() || void 0 !== t) && (function() {
                                ...
                                if (h) return h = !1;
                                setTimeout(function() { c._eventListeners.open && c._eventListeners.open.forEach(function(e) { e.fn(R.customEventObject("open", c, c), Object.assign({}, Z)) }) }, u)
                            }(), W())) {
                            var n;
                            if ("number" != typeof e && !R.isNumeric(e) || "number" != typeof t && !R.isNumeric(t)) m ? (n = Array.prototype.filter.call(v.querySelectorAll(".hc-chk"), function(e) { return e.value == m })[0], !Z.closeActiveLevel && Z.closeOpenLevels || (m = null)) : !1 === Z.closeOpenLevels && (n = (n = Array.prototype.filter.call(v.querySelectorAll(".hc-chk"), function(e) { return "true" === e.getAttribute("checked") }))[n.length - 1]);
                    ...
                    function $(t, n, e) {
                        ...
                        if (!1 === e && (o.style.transition = "none"), a.setAttribute("checked", !0), s.classList.add("sub-level-open"), i.classList.add("level-open"), i.querySelectorAll("[aria-controls]")[0].setAttribute("aria-expanded", !0), !1 === e && setTimeout(function() { o.style.transition = "" }, u), -1 === x.indexOf(r) && x.push(r), "overlap" === Z.levelOpen && (s.addEventListener("click", function() { return J(t, n) }), R.setTransform(v, t * Z.levelSpacing, Z.position), p)) {
                            var l = "x" === R.getAxis(Z.position) ? b : g;
                            R.setTransform(p, l + t * Z.levelSpacing, Z.position)
                        }
                        c._eventListeners["open.level"] && c._eventListeners["open.level"].forEach(function(e) { e.fn(R.customEventObject("open.level", c, o, { currentLevel: t, currentIndex: n }), Object.assign({}, Z)) }), C && (w(0, t, n), C = !1)
                    }
                    ...
                    function J(t, e) {
                        ...
                        if (0 < t && c._eventListeners["close.level"]) {
                            ...
                            c._eventListeners["close.level"].forEach(function(e) { e.fn(R.customEventObject("close.level", c, r, { currentLevel: t - 1, currentIndex: Q() }), Object.assign({}, Z)) })
                        }
                        C && (w(null, t - 1), C = !1)
                    }
                    console.error("%c! HC Offcanvas Nav:%c Menu must contain <ul> element.", "color: #fa253b", "color: default")
                };
            if (Array.isArray(e) || e instanceof NodeList) { for (var a = [], r = 0; r < e.length; r++) a.push(n(e[r])); return 1 < a.length ? a : a[0] }
            return n(e)
        };
    if (void 0 !== ne.jQuery) {
        var n = ne.jQuery,
...
function(n) {
    var e = n.hcOffcanvasNav,
        ...
        t = !1;
    try {
        var a = Object.defineProperty({}, "passive", { get: function() { t = { passive: !1 } } });
    ...
    Element.prototype.closest || (Element.prototype.closest = function(e) {
        ...
        return null
    }), Array.prototype.flat || Object.defineProperty(Array.prototype, "flat", { configurable: !0, value: function n() { var a = isNaN(arguments[0]) ? 1 : Number(arguments[0]); return a ? Array.prototype.reduce.call(this, function(e, t) { return Array.isArray(t) ? e.push.apply(e, n.call(t, a - 1)) : e.push(t), e }, []) : Array.prototype.slice.call(this) }, writable: !0 }), Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector);
    var r = (/iPad|iPhone|iPod/.test(navigator.userAgent) || !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform)) && !n.MSStream,
        ...
        s = function(e) { return !isNaN(parseFloat(e)) && isFinite(e) },
        l = function(e) { return "auto" === e ? "100%" : s(e) && 0 !== e ? e + "px" : e },
        c = function(e) {
        ...
        v = function(e, t) { if (e instanceof Element) return t ? Array.prototype.filter.call(e.children, function(e) { return e.matches(t) }) : e.children; var n = []; return Array.prototype.forEach.call(e, function(e) { n = t ? n.concat(Array.prototype.filter.call(e.children, function(e) { return e.matches(t) })) : n.concat(Array.prototype.slice.call(e.children)) }), n },
        u = function(o, e) {
            ...
            return function(e, t, n) {
                if (this) {
                    ...
                    if (this._eventListeners = this._eventListeners || {}, "add" === o) {
                        ...
                        for (var i in l.call(this, a, t, n), this._eventListeners) this._eventListeners[i] = this._eventListeners[i].filter(function(e) { return e.fn !== t }), this._eventListeners[i].length || delete this._eventListeners[i];
    ...
    var d = function(e, t, n) {
        ...
        p = function(e) { return -1 !== ["left", "right"].indexOf(e) ? "x" : "y" },
        f = function() {
            c("transform");
            return function(e, t, n) {
        ...
        h = function(e, t, n) { console.warn("%cHC Off-canvas Nav:%c " + n + "%c '" + e + "'%c is now deprecated and will be removed in the future. Use%c '" + t + "'%c option instead. See details about plugin usage at https://github.com/somewebmedia/hc-offcanvas-nav.", "color: #fa253b", "color: default", "color: #5595c6", "color: default", "color: #5595c6", "color: default") };
    e.Helpers = {
        supportsPassive: t,
        hasScrollBar: function() { return o.documentElement.scrollHeight > o.documentElement.clientHeight },
        isIos: r,
        isTouchDevice: i,
        isNumeric: s,
        formatSizeVal: l,
        toMs: function(e) { return parseFloat(e) * (/\ds$/.test(e) ? 1e3 : 1) },
        stopPropagation: function(e) { return e.stopPropagation() },
        preventDefault: function(e) { return e.preventDefault() },
        preventClick: function(t) { return function(e) { e.preventDefault(), e.stopPropagation(), "function" == typeof t && t() } },
        browserPrefix: c,
        children: v,
        wrap: function(e, t) { e.parentNode.insertBefore(t, e), t.appendChild(e) },
        data: function(e, t, n) {
        ...
        customEventObject: function(e, n, a, r) { return new function(e) { for (var t in this.bubbles = !1, this.cancelable = !1, this.composed = !1, this.currentTarget = a, this.data = r ? {} : null, this.defaultPrevented = !1, this.eventPhase = 0, this.isTrusted = !1, this.target = n, this.timeStamp = Date.now(), this.type = e, r) this.data[t] = r[t] }(e) },
        hasListener: function(e, t) { return (t ? (e._eventListeners || {})[t] : e._eventListeners) || !1 },
        debounce: function(a, r, i) {
            ...
            return function() {
                var e = this,
                    t = arguments,
                    n = i && !s;
                clearTimeout(s), s = setTimeout(function() { s = null, i || a.apply(e, t) }, r), n && a.apply(e, t)
            }
        },
        createElement: d,
        getElement: function(e) { var t = null; return "string" == typeof e ? t = o.querySelector(e) : n.jQuery && e instanceof n.jQuery && e.length ? t = e[0] : e instanceof Element && (t = e), t },
        getElementCssTag: function e(t) { return "string" == typeof t ? t : t.getAttribute("id") ? "#" + t.getAttribute("id") : t.getAttribute("class") ? t.tagName.toLowerCase() + "." + t.getAttribute("class").replace(/\s+/g, ".") : e(t.parentNode) + " > " + t.tagName.toLowerCase() },
        printStyle: function(e) {
            var r = d("style", { id: e }),
                i = {},
                s = {};
            o.head.appendChild(r);
            var a = function(e) { return ";" !== e.substr(-1) && (e += ";" !== e.substr(-1) ? ";" : ""), e };
            return {
                reset: function() { i = {}, s = {} },
                add: function(e, t, n) { e = e.trim(), t = t.trim(), n ? (n = n.trim(), s[n] = s[n] || {}, s[n][e] = a(t)) : i[e] = a(t) },
                remove: function(e, t) { e = e.trim(), t ? (t = t.trim(), void 0 !== s[t][e] && delete s[t][e]) : void 0 !== i[e] && delete i[e] },
                insert: function() {
                    var e = "";
                    for (var t in s) {
...
(function(q, g) { "function" === typeof define && define.amd ? define([], g) : "object" === typeof module && module.exports ? module.exports = g() : q.Rellax = g() })("undefined" !== typeof window ? window : global, function() {
    var q = function(g, u) {
        ...
        u && Object.keys(u).forEach(function(d) { a.options[d] = u[d] });
        u && u.breakpoints && C();
        g || (g = ".rellax");
        ...
        if (0 < k.length) {
            ...
            var F, B = function() {
                    ...
                    for (f = 0; f < a.elems.length; f++) {
                        ...
                        d.push({ baseX: y.x, baseY: y.y, top: t, left: h, height: g, width: k, speed: c, verticalSpeed: l, horizontalSpeed: m, verticalScrollAxis: p, horizontalScrollAxis: q, style: b, transform: r, zindex: u, min: x, max: A, minX: C, maxX: D, minY: E, maxY: L })
                    }
                    K();
